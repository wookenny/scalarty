...
object ValueNode {
  ...
  implicit val encodeValueNode: Encoder[ValueNode] = Encoder.instance {
    ...
    case n @ ModValue(_, _)                => Json.obj("ModValue" -> n.asJson)
  ...
  private val decodeMultilayerNoiseValue =
    Decoder[MultilayerNoiseValue].prepare(_.downField("MultilayerNoiseValue"))
  private val decodeClampValue = Decoder[ClampValue].prepare(_.downField("ClampValue"))
  private val decodeModValue = Decoder[ModValue].prepare(_.downField("ModValue"))
  ...
  implicit val decodeValueNode: Decoder[ValueNode] = decodeConstantValue
    ...
    .or(decodeModValue.widen[ValueNode])
...
object VectorNode {
  ...
  private val decodeSingleValueToVector =
    Decoder[SingleValueToVector].prepare(_.downField("SingleValueToVector"))
  private val decodeClampVector = Decoder[ClampVector].prepare(_.downField("ClampVector"))
...
object ColorNode {
  ...
  private val decodeSingleValueToColor =
    Decoder[SingleValueToColor].prepare(_.downField("SingleValueToColor"))
