...
final case class Config(
    out: String = "",
    in: String = "",
    supersampling: SamplingValue =
      SamplingValue.samplingValueRead.reads(Config.DefaultSupersampling),
    shadowsampling: SamplingValue =
      SamplingValue.samplingValueRead.reads(Config.DefaultShadowSupersampling),
