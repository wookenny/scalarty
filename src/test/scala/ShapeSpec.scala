...
class ShapeSpec extends Specification {
  ...
  val parseSphere = parseShape(Sphere(VectorBreeze3(1, 2, 3.14159), 2.3f))
  val parseTriangle = parseShape(Triangle(VectorBreeze3(1, 2, 0), VectorBreeze3(1, 2, 3), VectorBreeze3(2, 1, 4.2)))
